        ...
        <div>
            <div className="flex items-center">
                ...
                <div className="flex-1 flex justify-center">
                    <img src="/HayDay_TinyTom.png" alt="Tiny Tom" className="w-32 h-46" />
                </div>
            </div>
                        ...
                        <tbody>
                            {sorted.map((item, index) => (
                                <tr key={item.name} style={{ background: index % 2 === 0 ? "#1a1b1e" : "#1e1f23", color: "#e3e3e8" }}
                                    ...
                                    <td className="px-2 py-2 text-center border-b border-[#2e2e32]">{item.sell1} <img src="/gold-coin.png" alt="Coin" className="w-4 h-4 inline" /></td>
                                    <td className="px-2 py-2 text-center border-b border-[#2e2e32]">{item.sell10} <img src="/gold-coin.png" alt="Coin" className="w-4 h-4 inline" /></td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
            ...
            <div className="flex justify-center mt-24">
                <img src="/HayDay_Tom_sleep.png" alt="Tom Sleeping" className="w-60 h-46" />
            </div>
