    ...
    return (
        <div className="w-full">
            ...
            <div className="flex flex-col items-center gap-1 px-4 mb-6 md:mb-8">
                <img src={import.meta.env.BASE_URL + "HayDay_Logo.png"} alt="HayDay Guide" className="w-40 h-32 md:w-64 md:h-50" />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 xl:gap-12 w-full">
