    ...
    return (
        <div>
            ...
            <div className="flex flex-col items-center gap-1 px-4 mb-8">
                <img src="/HayDay_Logo.png" alt="HayDay Guide" className="w-64 h-50" />
            ...
            <div className="flex fit-content gap-12 justify-center">
                <RefBubble heading="Crops" image="/HayDay_Crop_Corn_4.png" reference="crops" setPage={setPage} />
                <RefBubble heading="Trees & Bushes" image="/HayDay_Blueberry_Bush_Stage_02_03.png" reference="plants" setPage={setPage} />
                <RefBubble heading="Tom Request Sheet" image="/HayDay_Tom_front.png" reference="tom" setPage={setPage} />
            </div>
        </div>
    )
}
